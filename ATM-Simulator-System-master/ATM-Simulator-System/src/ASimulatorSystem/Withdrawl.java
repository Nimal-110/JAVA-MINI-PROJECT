        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    int balance = 0;
                    while(rs.next()){
                        if(rs.getString("type").equalsIgnoreCase("Deposit")){  // Use 'type' instead of 'mode'
                            balance += Integer.parseInt(rs.getString("amount"));
                        }else if(rs.getString("type").equalsIgnoreCase("Withdrawl")){  // Account for withdrawal logic
                            balance -= Integer.parseInt(rs.getString("amount"));
                        }
                    }
